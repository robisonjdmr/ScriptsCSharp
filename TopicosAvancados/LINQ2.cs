    ...
    class LINQ2 {
        public static void Executar() {
            var alunos = new List<Aluno> {
                ...
                new Aluno() {Nome = "Andre", Idade = 21, Nota = 4.5},
            ...
            // se eu quiser somente a media dos alunos aprovados
            var mediaTumaAprovados = alunos.Where(a => a.Nota >= 7).Average(aluno => aluno.Nota);
            Console.WriteLine(mediaTumaAprovados); 
        }
    }
}
